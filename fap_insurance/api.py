...
class VerifyClaimRequest(BaseModel):
    ...
    policy_number: Optional[str] = Field(None, min_length=1, max_length=64, description="Internal policy reference")
    adjuster_notes: Optional[str] = Field(None, max_length=2000, description="Free-form notes")
